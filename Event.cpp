...
void Event::onKeyDown(SDLKey sym, SDLMod pMod, Uint16 unicode)
{
    //Pure virtual, do nothing
}

void Event::onKeyUp(SDLKey sym, SDLMod pMod, Uint16 unicode) {
    //Pure virtual, do nothing
}
...
void Event::onMouseMove(int nX, int nY, int relX, int relY, bool Left,bool Right,bool Middle)
{
    //Pure virtual, do nothing
}
